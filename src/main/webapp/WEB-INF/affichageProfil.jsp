            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="photo-profil">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQoF6HmYDfPRJUC9M_0U2I2JFoaqWJxwmFWxA&usqp=CAU" alt=""/>
                ...
                <div class="col-md-6">
                    <div class="profile-head">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="AProposNav" data-toggle="tab" href="#APropos" role="tab" aria-controls="home" aria-selected="true">A propos</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="AVendreNav" data-toggle="tab" href="#AVendre" role="tab" aria-controls="AVendre" aria-selected="false">Mes objets à vendre</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="VendusNav" data-toggle="tab" href="#Vendus" role="tab" aria-controls="Vendus" aria-selected="false">Mes objets vendus</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="tab-content profile-tab" id="myTabContent">
                        <div class="tab-pane fade show active" id="APropos" role="tabpanel" aria-labelledby="home-tab">
                            <div class="row">
                                <div class="col-md-6">
                                    <label>Pseudo</label>
                                </div>
