...
<div class="container">
    <div class="row justify-content-start">
        ...
        <div class="col-auto">
            <div class="dropdown">
                <button class="btn btn-secondary dropdown-toggle" type="button" id="Catégories" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    Catégories
                </button>
...
<form class="text-center justify-content-center d-flex align-items-center mt-4">
    <div class="w-25">
        ...
        <input type="search" class="form-control" id="InputFiltres" aria-describedby="InputFiltres" placeholder="Filtrer">
        <div id="InputFiltres" class="placeholder"></div>
    </div>
    ...
    <div class="input-group w-25 ms-3">
        ...
        <button type="button" class="btn btn-outline-primary" data-mdb-ripple-init>Rechercher</button>
    </div>
</form>
